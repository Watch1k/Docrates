	...
	function init(params) {
		...
		this.each(function () {
            ...
            if (!params.dontRemove) {
                $remove = $('<button type="button" class="' + REMOVE_CLASS + ' ' + config.removeButtonClass + '"></button>').appendTo($previous);
			...
			$fileButton = $('<button type="button" class="' + config.uploadButtonClass + '">' + config.uploadText + '</button>').insertBefore($self);
